	  ...
	  _prototypeProperties(Flux, null, {
	    ...
	    getActionIds: {
	      value: function getActionIds(key) {
	        ...
	        return _tailCall(actions.getConstants, [], actions);
	      },
	      writable: true,
	      configurable: true
	    },
	    ...
	    serialize: {
	      value: function serialize() {
	        ...
	        return _tailCall(JSON.stringify, [stateTree], JSON);
	      },
	      writable: true,
	      configurable: true
	    },
	  ...
	  _prototypeProperties(Store, null, {
	    getState: {
	      ...
	      value: function getState() {
	        return _tailCall(assign, [{}, this.state]);
	      },
	      writable: true,
	      configurable: true
	    },
	  ...
	  _prototypeProperties(Actions, null, {
	    ...
	    _getActionMethodNames: {
	      value: function _getActionMethodNames(instance) {
	        var _this = this;
	        var _temp;
	        return _tailCall((_temp = Object.getOwnPropertyNames(this.constructor.prototype)).filter, [function (name) {
	    ...
	    _wrapAction: {
	      value: function _wrapAction(methodName) {
	        ...
	        var action = function () {
	          ...
	          var body = originalMethod.call.apply(originalMethod, [_this].concat(_toArray(args)));

	          if (isPromise(body)) {
	            return _tailCall(body.then, [dispatchBody], body);
	          } else {
	    ...
	    _dispatch: {
	      value: function _dispatch(actionId, body, methodName) {
